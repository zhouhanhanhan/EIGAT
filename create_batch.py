            ...
            for i in range(batch_indices.shape[0]):
                ...
                if 'NELL' in args.data:
                    ...
                    if CUDA:
                        ...
                        scores5_head = model.batch_test(torch.LongTensor(
                            new_x_batch_head[4 * num_triples_each_shot: 5 * num_triples_each_shot, :]))
                        scores6_head = model.batch_test(torch.LongTensor(
                            new_x_batch_head[5 * num_triples_each_shot: 6 * num_triples_each_shot, :]))
                ...
                print("scores_head",scores_head.size())
                ...
                if 'NELL' in args.data:
                    ...
                    if CUDA:
                        ...
                        scores5_tail = model.batch_test(torch.LongTensor(
                            new_x_batch_tail[4 * num_triples_each_shot: 5 * num_triples_each_shot, :]))
                        scores6_tail = model.batch_test(torch.LongTensor(
                            new_x_batch_tail[5 * num_triples_each_shot: 6 * num_triples_each_shot, :]))
